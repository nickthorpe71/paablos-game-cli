...
var GodOfDeath = require("../Piece/GodOfDeath");
var GodOfLife = require("../Piece/GodOfLife");
...
var Board = function() {
    ...
    draw = function() {
        return tiles.map((row, rowIndex) => {
            ...
            var linesToKeep = rowIndex < 5 ? 4 : 5;
...
function tileGenerator() {
    return [
        [ 
            ...
            new Tile({x: 1, y: 0, piece: new Witch(),      element: new Black(),  environment: null}),
            new Tile({x: 2, y: 0, piece: new GodOfDeath(), element: new Red(),    environment: null}),
            new Tile({x: 3, y: 0, piece: new GodOfLife(),  element: new White(),  environment: null}),
            new Tile({x: 4, y: 0, piece: new Witch(),      element: new Yellow(), environment: null}),
        ...
        [
            ...
            new Tile({x: 1, y: 5, piece: new Witch(),      element: new Yellow(), environment: null}),
            new Tile({x: 2, y: 5, piece: new GodOfDeath(), element: new White(),  environment: null}),
            new Tile({x: 3, y: 5, piece: new GodOfLife(),  element: new Red(),    environment: null}),
            new Tile({x: 4, y: 5, piece: new Witch(),      element: new Black(),  environment: null}),
